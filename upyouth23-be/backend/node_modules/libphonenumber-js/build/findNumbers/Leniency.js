...
var _default = {
  ...
  VALID: function VALID(number, candidate, metadata) {
    if (!(0, _isValid["default"])(number, undefined, metadata) || !containsOnlyValidXChars(number, candidate.toString(), metadata)) {
      return false;
  ...
  STRICT_GROUPING: function STRICT_GROUPING(number, candidate, metadata, regExpCache) {
    ...
    if (!(0, _isValid["default"])(number, undefined, metadata) || !containsOnlyValidXChars(number, candidateString, metadata) || containsMoreThanOneSlashInNationalNumber(number, candidateString) || !isNationalPrefixPresentIfRequired(number, metadata)) {
      return false;
    }
